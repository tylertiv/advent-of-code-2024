...
latest_day=$(find days -type d -depth 1 | grep "day" | sort -V | tail -1)
...
new_day_dir="days/day$next_day_num"

echo "Creating $new_day_dir" && mkdir $new_day_dir && cp -r templates/day/* $new_day_dir
